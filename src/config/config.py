...
def get_train_config(config_file='C:/Users/admin/Desktop/ar-gcn_mrg100/src/config/train_config_res_gan.yaml'):
...
if __name__ == '__main__':
    cfg = get_train_config('C:/Users/admin/Desktop/ar-gcn_mrg100/src/config/train_config_ar_gcn.yaml')
    print(cfg['dataset'])
